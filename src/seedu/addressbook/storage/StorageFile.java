...
public class StorageFile {
     ...
     * 
     * @throws StorageFileNotFoundException if the storage file does not exist
     */
    
    public void checkIfFileExists() throws StorageFileNotFoundException {
    	if (!Files.exists(path)) {
    		throw new StorageFileNotFoundException("Error: Storage file is missing.");
    	}
    }
